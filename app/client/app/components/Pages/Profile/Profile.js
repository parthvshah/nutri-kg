...
class Profile extends React.Component {
    ...
    updateValue(field, newVal) {
        ...
        body["weight"] = basicInfoCopy.weight;
        body["height"] = basicInfoCopy.height;
        body["fitnessGoals"] = basicInfoCopy.fitnessGoals;
        body["allergies"] = basicInfoCopy.allergies;
        axios.put(
            apiPath,
            body,
            {
    ...
    render() {
        ...
        const content = (
            <div className="jumbotron center pt-3 pb-4 bg-light">
                ...
                <hr />
                <MutableBox updateFieldValue={this.updateValue} changeEditingStatus={this.changeEditingStatus} field="weight" inputType="text" fieldName="Weight (kg)" val={this.state.basicInfo["weight"]} />
                <hr />
                <MutableBox updateFieldValue={this.updateValue} changeEditingStatus={this.changeEditingStatus} field="height" inputType="text" fieldName="Height (cm)" val={this.state.basicInfo["height"]} />
                <hr />
                <MutableBox updateFieldValue={this.updateValue} changeEditingStatus={this.changeEditingStatus} field="fitnessGoals" inputType="text" fieldName="Fitness Goal" val={this.state.basicInfo["fitnessGoals"]} />
                <hr />
                <MutableBox updateFieldValue={this.updateValue} changeEditingStatus={this.changeEditingStatus} field="allergies" inputType="text" fieldName="Allergies" val={this.state.basicInfo["allergies"]} />
                <hr />
