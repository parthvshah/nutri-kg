  ...
  render() {
    ...
    const authLinks = (
      <Collapse isOpen={this.state.navbarIsOpen} navbar>
        <Nav className="mr-auto" navbar>
          <NavItem>
            <NavLink tag={Link} to="/explore" activeclassname="active">Explore</NavLink>
          </NavItem>
          <NavItem>
            <NavLink tag={Link} to="/meals" activeclassname="active">Meals</NavLink>
          </NavItem>
          {/* <NavItem>
    ...
    return (
      ...
      <Container className="pb-2 pt-2">
          <NavbarBrand tag={Link} to="/">NutriKG</NavbarBrand>
