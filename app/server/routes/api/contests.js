...
module.exports = (app) => {
  ...
  app.get('/api/contests/foods', function (req, res) {
  ...
  app.post('/api/contests/selectedFood', function (req, res) {
  ...
  app.post('/api/contests/recoFood', function (req, res) {
    var name = req.body.name;
    ...
    axios.post('http://127.0.0.1:5000/recoFood', body, {
      headers: {
